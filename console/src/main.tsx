...
// Attach window.Cognitwin.chat (Chat customization), extend
// window.Cognitwin.host with hooks + fetch, attach window.Cognitwin.audit.
installHostSdk();
...
// the registry so `window.Cognitwin.modules.<page>` is populated soon after
