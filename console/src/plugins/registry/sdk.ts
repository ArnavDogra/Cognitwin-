 ...
 * `window.Cognitwin.{menu, route, slot, audit}`. All plugin-facing methods take
...
export interface CognitwinMenuNamespace {
...
export interface CognitwinRouteNamespace {
...
export interface CognitwinSlotNamespace {
  fill(
    pluginId: string,
    name: SlotName,
    render: SlotRenderer,
...
export function buildMenuNamespace(): CognitwinMenuNamespace {
  return {
    add: (pluginId, item) => {
...
export function buildRouteNamespace(): CognitwinRouteNamespace {
  return {
    add: (pluginId, route) => {
...
export function buildSlotNamespace(): CognitwinSlotNamespace {
  return {
...
export function buildAuditNamespace(): CognitwinAuditNamespace {
  return {
