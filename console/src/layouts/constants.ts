...
export const GITHUB_URL = "https://github.com/agentscope-ai/Cognitwin" as const;
...
要更新 Cognitwin 到最新版本，可根据你的安装方式选择对应方法：
...
升级后重启服务 qwenpaw app。`,
  ...
  ru: `### Как обновить Cognitwin

Чтобы обновить Cognitwin, выберите способ в зависимости от типа установки:
...
After upgrading, restart the service with \`qwenpaw app\`.`,
  ...
  en: `### How to update Cognitwin

To update Cognitwin, use the method matching your installation type:
